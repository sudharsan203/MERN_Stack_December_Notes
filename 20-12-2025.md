...
### Use Cases
- Fetch all records: `GET /api/users`
- Fetch a specific record: `GET /api/users/123`
...
### Use Cases
- Create new record: `POST /api/users`
- Submit form data
- Upload files
- Trigger actions
...
### Use Cases
- Update entire record: `PUT /api/users/123`
...
### Use Cases
- Delete specific record: `DELETE /api/users/123`
- Remove resources
- Clear data
